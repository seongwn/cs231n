    ...
    def loss(self, X, y=None):
        ...
        if self.normalization == None:
            ...
            for i in range(1, L):
                ...
                if self.use_dropout:
                    Xs[i],dropout_caches[i] = dropout_forward(Xs[i],dropout_param) 
        ...
        for i in range(1, L):
            if self.use_dropout:
                dXs[L-i] = dropout_backward(dXs[L-i], dropout_caches[L-1-i])
            else:
                pass
